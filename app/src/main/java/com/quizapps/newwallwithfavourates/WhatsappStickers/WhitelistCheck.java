...
package com.quizapps.newwallwithfavourates.WhatsappStickers;
    ...
    public static boolean isPackageInstalled(String packageName, PackageManager packageManager) {
        try {
            ...
            if (applicationInfo != null) {
                //Log.e( "","app is installed"+packageName);
                return applicationInfo.enabled;

            } else {
                //Log.e( "","app is not installed"+packageName);
                return false;
            }
        } catch (PackageManager.NameNotFoundException e) {
            //Log.e( "","app not installed"+e);
            return false;
        }
    }
